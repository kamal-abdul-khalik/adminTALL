    ...
    <div class="mb-5" x-data="{ isOpen: @if ($openFilter || request('openFilter')) true @else false @endif }">
        ...
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                <x-form.input type="email" id="email" name="email" :label="__('Email')"
                    wire:model.live.debounce.500ms="email" />
                <x-form.daterange id="joined" name="joined" :label="__('Joined Date Range')"
                    wire:model.live.debounce.500ms="joined" />
            </div>
        </div>
